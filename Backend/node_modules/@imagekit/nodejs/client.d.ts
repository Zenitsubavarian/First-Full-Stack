import type { RequestInit, RequestInfo } from "./src/internal/builtin-types.js";
import type { PromiseOrValue, MergedRequestInit, FinalizedRequestInit } from "./src/internal/types.js";
export type { Logger, LogLevel } from "./src/internal/utils/log.js";
import * as Opts from "./src/internal/request-options.js";
import * as Errors from "./src/core/error.js";
import * as Uploads from "./src/core/uploads.js";
import * as API from "./src/resources/index.js";
import { APIPromise } from "./src/core/api-promise.js";
import { AssetListParams, AssetListResponse, Assets } from "./src/resources/assets.js";
import { CustomMetadataField, CustomMetadataFieldCreateParams, CustomMetadataFieldDeleteResponse, CustomMetadataFieldListParams, CustomMetadataFieldListResponse, CustomMetadataFieldUpdateParams, CustomMetadataFields } from "./src/resources/custom-metadata-fields.js";
import { SavedExtensionCreateParams, SavedExtensionListResponse, SavedExtensionUpdateParams, SavedExtensions } from "./src/resources/saved-extensions.js";
import { BaseWebhookEvent, FileCreateEvent, FileDeleteEvent, FileUpdateEvent, FileVersionCreateEvent, FileVersionDeleteEvent, UnsafeUnwrapWebhookEvent, UnwrapWebhookEvent, UploadPostTransformErrorEvent, UploadPostTransformSuccessEvent, UploadPreTransformErrorEvent, UploadPreTransformSuccessEvent, VideoTransformationAcceptedEvent, VideoTransformationErrorEvent, VideoTransformationReadyEvent, Webhooks } from "./src/resources/webhooks.js";
import { Accounts } from "./src/resources/accounts/accounts.js";
import { Beta } from "./src/resources/beta/beta.js";
import { Cache } from "./src/resources/cache/cache.js";
import { File, FileCopyParams, FileCopyResponse, FileMoveParams, FileMoveResponse, FileRenameParams, FileRenameResponse, FileUpdateParams, FileUpdateResponse, FileUploadParams, FileUploadResponse, Files, Folder, Metadata, UpdateFileRequest } from "./src/resources/files/files.js";
import { FolderCopyParams, FolderCopyResponse, FolderCreateParams, FolderCreateResponse, FolderDeleteParams, FolderDeleteResponse, FolderMoveParams, FolderMoveResponse, FolderRenameParams, FolderRenameResponse, Folders } from "./src/resources/folders/folders.js";
import { type Fetch } from "./src/internal/builtin-types.js";
import { HeadersLike, NullableHeaders } from "./src/internal/headers.js";
import { FinalRequestOptions, RequestOptions } from "./src/internal/request-options.js";
import { type LogLevel, type Logger } from "./src/internal/utils/log.js";
...
export declare class ImageKit {
    ...
    files: API.Files;
    savedExtensions: API.SavedExtensions;
    assets: API.Assets;
    cache: API.Cache;
    folders: API.Folders;
