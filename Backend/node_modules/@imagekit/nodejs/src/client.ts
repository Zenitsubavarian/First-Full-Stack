...
import type { RequestInit, RequestInfo, BodyInit } from '@imagekit/nodejs/src/internal/builtin-types';
import type { HTTPMethod, PromiseOrValue, MergedRequestInit, FinalizedRequestInit } from '@imagekit/nodejs/src/internal/types';
import { uuid4 } from '@imagekit/nodejs/src/internal/utils/uuid';
import { validatePositiveInteger, isAbsoluteURL, safeJSON } from '@imagekit/nodejs/src/internal/utils/values';
import { sleep } from '@imagekit/nodejs/src/internal/utils/sleep';
export type { Logger, LogLevel } from '@imagekit/nodejs/src/internal/utils/log';
import { castToError, isAbortError } from '@imagekit/nodejs/src/internal/errors';
import type { APIResponseProps } from '@imagekit/nodejs/src/internal/parse';
import { getPlatformHeaders } from '@imagekit/nodejs/src/internal/detect-platform';
import * as Shims from '@imagekit/nodejs/src/internal/shims';
import * as Opts from '@imagekit/nodejs/src/internal/request-options';
import { stringifyQuery } from '@imagekit/nodejs/src/internal/utils/query';
import { VERSION } from '@imagekit/nodejs/src/version';
import * as Errors from '@imagekit/nodejs/src/core/error';
import * as Uploads from '@imagekit/nodejs/src/core/uploads';
import * as API from '@imagekit/nodejs/src/resources/index';
import { APIPromise } from '@imagekit/nodejs/src/core/api-promise';
import { AssetListParams, AssetListResponse, Assets } from '@imagekit/nodejs/src/resources/assets';
import {
  CustomMetadataField,
...
} from '@imagekit/nodejs/src/resources/custom-metadata-fields';
import {
  SavedExtensionCreateParams,
  SavedExtensionListResponse,
  SavedExtensionUpdateParams,
  SavedExtensions,
} from '@imagekit/nodejs/src/resources/saved-extensions';
import {
  BaseWebhookEvent,
  FileCreateEvent,
  FileDeleteEvent,
  ...
  Webhooks,
} from '@imagekit/nodejs/src/resources/webhooks';
import { Accounts } from '@imagekit/nodejs/src/resources/accounts/accounts';
import { Beta } from '@imagekit/nodejs/src/resources/beta/beta';
import { Cache } from '@imagekit/nodejs/src/resources/cache/cache';
import {
  File,
  FileCopyParams,
  FileCopyResponse,
  ...
  Metadata,
  UpdateFileRequest,
} from '@imagekit/nodejs/src/resources/files/files';
import {
  FolderCopyParams,
  FolderCopyResponse,
  FolderCreateParams,
  ...
  Folders,
} from '@imagekit/nodejs/src/resources/folders/folders';
import { type Fetch } from '@imagekit/nodejs/src/internal/builtin-types';
import { HeadersLike, NullableHeaders, buildHeaders } from '@imagekit/nodejs/src/internal/headers';
import { FinalRequestOptions, RequestOptions } from '@imagekit/nodejs/src/internal/request-options';
import { toBase64 } from '@imagekit/nodejs/src/internal/utils/base64';
import { readEnv } from '@imagekit/nodejs/src/internal/utils/env';
import {
  type LogLevel,
  type Logger,
  ...
  loggerFor,
  parseLogLevel,
} from '@imagekit/nodejs/src/internal/utils/log';
import { isEmptyObj } from '@imagekit/nodejs/src/internal/utils/values';
...
export class ImageKit {
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://api.imagekit.io';
  }
