...
export declare class URLEndpoints extends APIResource {
    /**
     ...
     * ```
     */
    update(id: string, body: URLEndpointUpdateParams, options?: RequestOptions): APIPromise<URLEndpointResponse>;
    /**
     * **Note:** This API is currently in beta.
...
export declare namespace URLEndpointRequest {
...
export declare namespace URLEndpointResponse {
    interface Cloudinary {
        /**
         * Whether to preserve `<asset_type>/<delivery_type>` in the rewritten URL.
         */
...
export interface URLEndpointCreateParams {
     ...
     * Configuration for third-party URL rewriting.
     */
    urlRewriter?: URLEndpointCreateParams.Cloudinary | URLEndpointCreateParams.Imgix | URLEndpointCreateParams.Akamai;
}
export declare namespace URLEndpointCreateParams {
    interface Cloudinary {
        type: 'CLOUDINARY';
        /**
         * Whether to preserve `<asset_type>/<delivery_type>` in the rewritten URL.
...
export interface URLEndpointUpdateParams {
     ...
     * Configuration for third-party URL rewriting.
     */
    urlRewriter?: URLEndpointUpdateParams.Cloudinary | URLEndpointUpdateParams.Imgix | URLEndpointUpdateParams.Akamai;
}
export declare namespace URLEndpointUpdateParams {
    interface Cloudinary {
        type: 'CLOUDINARY';
        /**
         * Whether to preserve `<asset_type>/<delivery_type>` in the rewritten URL.
...
export declare namespace URLEndpoints {
    export { type URLEndpointRequest as URLEndpointRequest, type URLEndpointResponse as URLEndpointResponse, type URLEndpointListResponse as URLEndpointListResponse, type URLEndpointCreateParams as URLEndpointCreateParams, type URLEndpointUpdateParams as URLEndpointUpdateParams, };
}
//# sourceMappingURL=url-endpoints.d.ts.map