...
export declare class UsageAnalytics extends APIResource {
    /**
...
export declare namespace UsageAnalyticsResponse {
    /**
     * CDN traffic grouped by browser.
     */
    interface Browser {
    ...
    namespace Browser {
        interface ByBandwidth extends UsageAnalyticsAPI.RequestBandwidthEntry {
            /**
             * Browser name (e.g. `Chrome`).
             */
            name: string;
        }
        interface ByRequest extends UsageAnalyticsAPI.RequestBandwidthEntry {
            /**
             * Browser name (e.g. `Chrome`).
             */
            name: string;
...
export declare namespace UsageAnalytics {
    export { type RequestBandwidthEntry as RequestBandwidthEntry, type UsageAnalyticsResponse as UsageAnalyticsResponse, type UsageAnalyticsGetParams as UsageAnalyticsGetParams, };
}
