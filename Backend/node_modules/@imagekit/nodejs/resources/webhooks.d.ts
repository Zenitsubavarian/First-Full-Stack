...
export declare namespace FileDeleteEvent {
    interface Data {
        /**
...
export declare namespace FileVersionDeleteEvent {
    interface Data {
        /**
         * The unique `fileId` of the deleted file.
         */
...
export declare namespace UploadPreTransformSuccessEvent {
    ...
    interface Data {
        ...
        selectedFieldsSchema?: {
            [key: string]: Data.SelectedFieldsSchema;
        };
        /**
